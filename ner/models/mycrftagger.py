...
# The difference between original crf tagger and myself tagger is:
# the encoder is allowed to be None, for the use of bert-embedding
# little modify in get_metrices

@Model.register("my_crf_tagger")
class MyCrfTagger(Model):
    """
    ...
    def get_metrics(self, reset: bool = False) -> Dict[str, float]:
        ...
        if self.calculate_span_f1:
            ...
            if self._verbose_metrics:
                metrics_to_return['f1-measure'] = f1_dict['f1-measure-overall']
                metrics_to_return['precision'] = f1_dict['precision-overall']
                metrics_to_return['recall'] = f1_dict['recall-overall']
            # else:
